...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of LQQSegmentBar.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/85174695/LQQSegmentBar'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '85174695' => 'jesus_lqq@163.com' }
  s.source           = { :git => 'https://github.com/85174695/LQQSegmentBar.git', :tag => s.version.to_s }
